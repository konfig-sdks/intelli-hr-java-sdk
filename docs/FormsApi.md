...
|------------- | ------------- | -------------|
| [**findById**](FormsApi.md#findById) | **GET** /forms/{id} | Find a Form by ID |


<a name="findById"></a>
# **findById**
> Forms findById().execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling FormsApi#findById");
    ...
    try {
      ApiResponse<Forms> response = client
              .forms
              .findById()
              .executeWithHttpInfo();
