...
|------------ | ------------- | ------------- | -------------|
|**id** | **String** | The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to whom this [User](https://developers.intellihr.io/docs/v1/) belongs. |  [optional] |
