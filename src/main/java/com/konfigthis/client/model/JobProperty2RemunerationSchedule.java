...
import com.konfigthis.client.model.JobProperty2RemunerationScheduleAdditionsInner;
import com.konfigthis.client.model.JobProperty2RemunerationScheduleAdditionsToTotalInner;
import com.konfigthis.client.model.JobProperty2RemunerationScheduleBreakdownsInner;
import com.konfigthis.client.model.JobProperty2RemunerationScheduleDeductionsInner;
import com.konfigthis.client.model.JobProperty2RemunerationScheduleEmploymentCondition;
...
public class JobProperty2RemunerationSchedule {
  ...
  private JobProperty2RemunerationScheduleEmploymentCondition employmentCondition;

  public static final String SERIALIZED_NAME_ADDITIONS = "additions";
  @SerializedName(SERIALIZED_NAME_ADDITIONS)
  private List<JobProperty2RemunerationScheduleAdditionsInner> additions = null;

  public static final String SERIALIZED_NAME_DEDUCTIONS = "deductions";
  @SerializedName(SERIALIZED_NAME_DEDUCTIONS)
  private List<JobProperty2RemunerationScheduleDeductionsInner> deductions = null;
  ...
  private List<JobProperty2RemunerationScheduleAdditionsToTotalInner> additionsToTotal = null;

  public static final String SERIALIZED_NAME_BREAKDOWNS = "breakdowns";
  @SerializedName(SERIALIZED_NAME_BREAKDOWNS)
  private List<JobProperty2RemunerationScheduleBreakdownsInner> breakdowns = null;

  public static final String SERIALIZED_NAME_CUSTOM_FIELDS = "customFields";
  @SerializedName(SERIALIZED_NAME_CUSTOM_FIELDS)
  private CustomFieldsResponse customFields = null;

  public JobProperty2RemunerationSchedule() {
  }

  public JobProperty2RemunerationSchedule type(String type) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule baseAnnualSalary(Double baseAnnualSalary) {
  ...
  public JobProperty2RemunerationSchedule baseAnnualSalary(Integer baseAnnualSalary) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule baseHourlyRate(Double baseHourlyRate) {
  ...
  public JobProperty2RemunerationSchedule baseHourlyRate(Integer baseHourlyRate) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule currency(String currency) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule hoursPerCycle(Double hoursPerCycle) {
  ...
  public JobProperty2RemunerationSchedule hoursPerCycle(Integer hoursPerCycle) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule payCycle(String payCycle) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule annualPackage(Double annualPackage) {
  ...
  public JobProperty2RemunerationSchedule annualPackage(Integer annualPackage) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule hourlyPackage(Double hourlyPackage) {
  ...
  public JobProperty2RemunerationSchedule hourlyPackage(Integer hourlyPackage) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule currencyConversionOccurred(Boolean currencyConversionOccurred) {
  ...
  **/
  ...
  public JobProperty2RemunerationSchedule employmentCondition(JobProperty2RemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  **/
  ...
  public JobProperty2RemunerationScheduleEmploymentCondition getEmploymentCondition() {
    return employmentCondition;
  }


  public void setEmploymentCondition(JobProperty2RemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  public JobProperty2RemunerationSchedule additions(List<JobProperty2RemunerationScheduleAdditionsInner> additions) {
  ...
  public JobProperty2RemunerationSchedule addAdditionsItem(JobProperty2RemunerationScheduleAdditionsInner additionsItem) {
  ...
  **/
  ...
  public List<JobProperty2RemunerationScheduleAdditionsInner> getAdditions() {
    return additions;
  }


  public void setAdditions(List<JobProperty2RemunerationScheduleAdditionsInner> additions) {
  ...
  public JobProperty2RemunerationSchedule deductions(List<JobProperty2RemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobProperty2RemunerationSchedule addDeductionsItem(JobProperty2RemunerationScheduleDeductionsInner deductionsItem) {
  ...
  **/
  ...
  public List<JobProperty2RemunerationScheduleDeductionsInner> getDeductions() {
    return deductions;
  }


  public void setDeductions(List<JobProperty2RemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobProperty2RemunerationSchedule additionsToTotal(List<JobProperty2RemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobProperty2RemunerationSchedule addAdditionsToTotalItem(JobProperty2RemunerationScheduleAdditionsToTotalInner additionsToTotalItem) {
  ...
  **/
  ...
  public List<JobProperty2RemunerationScheduleAdditionsToTotalInner> getAdditionsToTotal() {
    return additionsToTotal;
  }


  public void setAdditionsToTotal(List<JobProperty2RemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobProperty2RemunerationSchedule breakdowns(List<JobProperty2RemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobProperty2RemunerationSchedule addBreakdownsItem(JobProperty2RemunerationScheduleBreakdownsInner breakdownsItem) {
  ...
  **/
  ...
  public List<JobProperty2RemunerationScheduleBreakdownsInner> getBreakdowns() {
    return breakdowns;
  }


  public void setBreakdowns(List<JobProperty2RemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobProperty2RemunerationSchedule customFields(CustomFieldsResponse customFields) {
  ...
  **/
   ...
   * @return the JobProperty2RemunerationSchedule instance itself
   */
  public JobProperty2RemunerationSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobProperty2RemunerationSchedule jobProperty2RemunerationSchedule = (JobProperty2RemunerationSchedule) o;
    return Objects.equals(this.type, jobProperty2RemunerationSchedule.type) &&
        Objects.equals(this.baseAnnualSalary, jobProperty2RemunerationSchedule.baseAnnualSalary) &&
        Objects.equals(this.baseHourlyRate, jobProperty2RemunerationSchedule.baseHourlyRate) &&
        Objects.equals(this.currency, jobProperty2RemunerationSchedule.currency) &&
        Objects.equals(this.hoursPerCycle, jobProperty2RemunerationSchedule.hoursPerCycle) &&
        Objects.equals(this.payCycle, jobProperty2RemunerationSchedule.payCycle) &&
        Objects.equals(this.annualPackage, jobProperty2RemunerationSchedule.annualPackage) &&
        Objects.equals(this.hourlyPackage, jobProperty2RemunerationSchedule.hourlyPackage) &&
        Objects.equals(this.currencyConversionOccurred, jobProperty2RemunerationSchedule.currencyConversionOccurred) &&
        Objects.equals(this.employmentCondition, jobProperty2RemunerationSchedule.employmentCondition) &&
        Objects.equals(this.additions, jobProperty2RemunerationSchedule.additions) &&
        Objects.equals(this.deductions, jobProperty2RemunerationSchedule.deductions) &&
        Objects.equals(this.additionsToTotal, jobProperty2RemunerationSchedule.additionsToTotal) &&
        Objects.equals(this.breakdowns, jobProperty2RemunerationSchedule.breakdowns) &&
        Objects.equals(this.customFields, jobProperty2RemunerationSchedule.customFields)&&
        Objects.equals(this.additionalProperties, jobProperty2RemunerationSchedule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobProperty2RemunerationSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobProperty2RemunerationSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobProperty2RemunerationSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobProperty2RemunerationSchedule is not found in the empty JSON string", JobProperty2RemunerationSchedule.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("employmentCondition") != null && !jsonObj.get("employmentCondition").isJsonNull()) {
        JobProperty2RemunerationScheduleEmploymentCondition.validateJsonObject(jsonObj.getAsJsonObject("employmentCondition"));
      }
      if (jsonObj.get("additions") != null && !jsonObj.get("additions").isJsonNull()) {
        ...
        if (jsonArrayadditions != null) {
          ...
          for (int i = 0; i < jsonArrayadditions.size(); i++) {
            JobProperty2RemunerationScheduleAdditionsInner.validateJsonObject(jsonArrayadditions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("deductions") != null && !jsonObj.get("deductions").isJsonNull()) {
        ...
        if (jsonArraydeductions != null) {
          ...
          for (int i = 0; i < jsonArraydeductions.size(); i++) {
            JobProperty2RemunerationScheduleDeductionsInner.validateJsonObject(jsonArraydeductions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("additionsToTotal") != null && !jsonObj.get("additionsToTotal").isJsonNull()) {
        ...
        if (jsonArrayadditionsToTotal != null) {
          ...
          for (int i = 0; i < jsonArrayadditionsToTotal.size(); i++) {
            JobProperty2RemunerationScheduleAdditionsToTotalInner.validateJsonObject(jsonArrayadditionsToTotal.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("breakdowns") != null && !jsonObj.get("breakdowns").isJsonNull()) {
        ...
        if (jsonArraybreakdowns != null) {
          ...
          for (int i = 0; i < jsonArraybreakdowns.size(); i++) {
            JobProperty2RemunerationScheduleBreakdownsInner.validateJsonObject(jsonArraybreakdowns.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobProperty2RemunerationSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobProperty2RemunerationSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobProperty2RemunerationSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobProperty2RemunerationSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<JobProperty2RemunerationSchedule>() {
           @Override
           public void write(JsonWriter out, JobProperty2RemunerationSchedule value) throws IOException {
           ...
           @Override
           public JobProperty2RemunerationSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobProperty2RemunerationSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobProperty2RemunerationSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobProperty2RemunerationSchedule
  * @throws IOException if the JSON string is invalid with respect to JobProperty2RemunerationSchedule
  */
  public static JobProperty2RemunerationSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobProperty2RemunerationSchedule.class);
  }

 /**
  * Convert an instance of JobProperty2RemunerationSchedule to an JSON string
  *
  * @return JSON string
  */
