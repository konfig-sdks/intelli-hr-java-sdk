...
public class PayGradeCreateRequest {
  ...
  private String payGradeType = "FIXED";
  ...
  private List<PayGradeCreateRequestPayStepsInner> paySteps = null;

  public PayGradeCreateRequest() {
  }

  public PayGradeCreateRequest description(String description) {
  ...
  **/
  ...
  public PayGradeCreateRequest name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Founder", required = true, value = "The name assigned to this [Pay Grade](https://developers.intellihr.io/docs/v1/).")
  ...
  public PayGradeCreateRequest code(String code) {
  ...
  **/
  ...
  public PayGradeCreateRequest employmentCondition(PayGradeCreateRequestEmploymentCondition employmentCondition) {
  ...
  **/
  ...
  public PayGradeCreateRequestEmploymentCondition getEmploymentCondition() {
    return employmentCondition;
  }


  public void setEmploymentCondition(PayGradeCreateRequestEmploymentCondition employmentCondition) {
  ...
  public PayGradeCreateRequest payGradeType(String payGradeType) {
  ...
  **/
  ...
  public PayGradeCreateRequest isOverridable(Boolean isOverridable) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Allow this [Pay Grade](https://developers.intellihr.io/docs/v1/) value to be overwritten.")
  ...
  public PayGradeCreateRequest permanentHourlyRate(Double permanentHourlyRate) {
  ...
  public PayGradeCreateRequest permanentHourlyRate(Integer permanentHourlyRate) {
  ...
  **/
  ...
  public PayGradeCreateRequest permanentHourlyRateCurrency(String permanentHourlyRateCurrency) {
  ...
  **/
  ...
  public PayGradeCreateRequest casualHourlyRate(Double casualHourlyRate) {
  ...
  public PayGradeCreateRequest casualHourlyRate(Integer casualHourlyRate) {
  ...
  **/
  ...
  public PayGradeCreateRequest casualHourlyRateCurrency(String casualHourlyRateCurrency) {
  ...
  **/
  ...
  public PayGradeCreateRequest annualSalary(Double annualSalary) {
  ...
  public PayGradeCreateRequest annualSalary(Integer annualSalary) {
  ...
  **/
  ...
  public PayGradeCreateRequest annualSalaryCurrency(String annualSalaryCurrency) {
  ...
  **/
  ...
  public PayGradeCreateRequest paySteps(List<PayGradeCreateRequestPayStepsInner> paySteps) {
  ...
  public PayGradeCreateRequest addPayStepsItem(PayGradeCreateRequestPayStepsInner payStepsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of Paygrade Step Rates. This array is to be used when payGradeType of \"Step\" is used.")

  public List<PayGradeCreateRequestPayStepsInner> getPaySteps() {
    return paySteps;
  }


  public void setPaySteps(List<PayGradeCreateRequestPayStepsInner> paySteps) {
   ...
   * @return the PayGradeCreateRequest instance itself
   */
  public PayGradeCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayGradeCreateRequest payGradeCreateRequest = (PayGradeCreateRequest) o;
    return Objects.equals(this.description, payGradeCreateRequest.description) &&
        Objects.equals(this.name, payGradeCreateRequest.name) &&
        Objects.equals(this.code, payGradeCreateRequest.code) &&
        Objects.equals(this.employmentCondition, payGradeCreateRequest.employmentCondition) &&
        Objects.equals(this.payGradeType, payGradeCreateRequest.payGradeType) &&
        Objects.equals(this.isOverridable, payGradeCreateRequest.isOverridable) &&
        Objects.equals(this.permanentHourlyRate, payGradeCreateRequest.permanentHourlyRate) &&
        Objects.equals(this.permanentHourlyRateCurrency, payGradeCreateRequest.permanentHourlyRateCurrency) &&
        Objects.equals(this.casualHourlyRate, payGradeCreateRequest.casualHourlyRate) &&
        Objects.equals(this.casualHourlyRateCurrency, payGradeCreateRequest.casualHourlyRateCurrency) &&
        Objects.equals(this.annualSalary, payGradeCreateRequest.annualSalary) &&
        Objects.equals(this.annualSalaryCurrency, payGradeCreateRequest.annualSalaryCurrency) &&
        Objects.equals(this.paySteps, payGradeCreateRequest.paySteps)&&
        Objects.equals(this.additionalProperties, payGradeCreateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, code, employmentCondition, payGradeType, isOverridable, permanentHourlyRate, permanentHourlyRateCurrency, casualHourlyRate, casualHourlyRateCurrency, annualSalary, annualSalaryCurrency, paySteps, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayGradeCreateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayGradeCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayGradeCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayGradeCreateRequest is not found in the empty JSON string", PayGradeCreateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayGradeCreateRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("employmentCondition") != null && !jsonObj.get("employmentCondition").isJsonNull()) {
        PayGradeCreateRequestEmploymentCondition.validateJsonObject(jsonObj.getAsJsonObject("employmentCondition"));
      }
      ...
      if (jsonObj.get("paySteps") != null && !jsonObj.get("paySteps").isJsonNull()) {
        ...
        if (jsonArraypaySteps != null) {
          ...
          for (int i = 0; i < jsonArraypaySteps.size(); i++) {
            PayGradeCreateRequestPayStepsInner.validateJsonObject(jsonArraypaySteps.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayGradeCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayGradeCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayGradeCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayGradeCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PayGradeCreateRequest>() {
           @Override
           public void write(JsonWriter out, PayGradeCreateRequest value) throws IOException {
           ...
           @Override
           public PayGradeCreateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayGradeCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayGradeCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayGradeCreateRequest
  * @throws IOException if the JSON string is invalid with respect to PayGradeCreateRequest
  */
  public static PayGradeCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayGradeCreateRequest.class);
  }

 /**
  * Convert an instance of PayGradeCreateRequest to an JSON string
  *
  * @return JSON string
  */
