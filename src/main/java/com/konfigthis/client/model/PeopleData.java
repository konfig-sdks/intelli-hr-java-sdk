...
import com.konfigthis.client.model.PeopleDataAddressesInner;
import com.konfigthis.client.model.PeopleDataEmailAddressesInner;
import com.konfigthis.client.model.PeopleDataJobsInner;
import com.konfigthis.client.model.PeopleDataMedicalConditionsInner;
import com.konfigthis.client.model.PeopleDataPhoneNumbersInner;
import com.konfigthis.client.model.PeopleDataWorkRights;
...
public class PeopleData {
  ...
  private List<PeopleDataMedicalConditionsInner> medicalConditions = null;

  public static final String SERIALIZED_NAME_EMAIL_ADDRESSES = "emailAddresses";
  @SerializedName(SERIALIZED_NAME_EMAIL_ADDRESSES)
  private List<PeopleDataEmailAddressesInner> emailAddresses = null;
  ...
  private List<PeopleDataAddressesInner> addresses = null;

  public static final String SERIALIZED_NAME_PHONE_NUMBERS = "phoneNumbers";
  @SerializedName(SERIALIZED_NAME_PHONE_NUMBERS)
  private List<PeopleDataPhoneNumbersInner> phoneNumbers = null;
  ...
  public PeopleData title(Object title) {
  ...
  **/
  ...
  public PeopleData id(String id) {
  ...
  **/
  ...
  public PeopleData displayName(String displayName) {
  ...
  **/
  ...
  public PeopleData firstName(Object firstName) {
  ...
  **/
  ...
  public PeopleData middleName(Object middleName) {
  ...
  **/
  ...
  public PeopleData lastName(String lastName) {
  ...
  **/
  ...
  public PeopleData preferredName(Object preferredName) {
  ...
  **/
  ...
  public PeopleData dateOfBirth(Object dateOfBirth) {
  ...
  **/
  ...
  public PeopleData gender(String gender) {
  ...
  **/
  ...
  public PeopleData isSupervisor(Boolean isSupervisor) {
  ...
  **/
  ...
  public PeopleData employeeNumber(Object employeeNumber) {
  ...
  **/
  ...
  public PeopleData autoIncrementIntellihrId(Double autoIncrementIntellihrId) {
  ...
  public PeopleData autoIncrementIntellihrId(Integer autoIncrementIntellihrId) {
  ...
  **/
  ...
  public PeopleData medicalConditions(List<PeopleDataMedicalConditionsInner> medicalConditions) {
  ...
  public PeopleData addMedicalConditionsItem(PeopleDataMedicalConditionsInner medicalConditionsItem) {
  ...
  **/
  ...
  public List<PeopleDataMedicalConditionsInner> getMedicalConditions() {
    return medicalConditions;
  }


  public void setMedicalConditions(List<PeopleDataMedicalConditionsInner> medicalConditions) {
  ...
  public PeopleData emailAddresses(List<PeopleDataEmailAddressesInner> emailAddresses) {
  ...
  public PeopleData addEmailAddressesItem(PeopleDataEmailAddressesInner emailAddressesItem) {
  ...
  **/
  ...
  public List<PeopleDataEmailAddressesInner> getEmailAddresses() {
    return emailAddresses;
  }


  public void setEmailAddresses(List<PeopleDataEmailAddressesInner> emailAddresses) {
  ...
  public PeopleData emergencyContact(DataPropertyInnerEmergencyContact emergencyContact) {
  ...
  **/
  ...
  public PeopleData employmentStatus(String employmentStatus) {
  ...
  **/
  ...
  public PeopleData jobs(List<PeopleDataJobsInner> jobs) {
  ...
  public PeopleData addJobsItem(PeopleDataJobsInner jobsItem) {
    if (this.jobs == null) {
  ...
  **/
  ...
  public List<PeopleDataJobsInner> getJobs() {
    return jobs;
  }


  public void setJobs(List<PeopleDataJobsInner> jobs) {
  ...
  public PeopleData workRights(PeopleDataWorkRights workRights) {
  ...
  **/
  ...
  public PeopleDataWorkRights getWorkRights() {
    return workRights;
  }


  public void setWorkRights(PeopleDataWorkRights workRights) {
  ...
  public PeopleData primaryEmailAddress(Object primaryEmailAddress) {
  ...
  **/
  ...
  public PeopleData primaryPhoneNumber(Object primaryPhoneNumber) {
  ...
  **/
  ...
  public PeopleData addresses(List<PeopleDataAddressesInner> addresses) {
  ...
  public PeopleData addAddressesItem(PeopleDataAddressesInner addressesItem) {
  ...
  **/
  ...
  public List<PeopleDataAddressesInner> getAddresses() {
    return addresses;
  }


  public void setAddresses(List<PeopleDataAddressesInner> addresses) {
  ...
  public PeopleData phoneNumbers(List<PeopleDataPhoneNumbersInner> phoneNumbers) {
  ...
  public PeopleData addPhoneNumbersItem(PeopleDataPhoneNumbersInner phoneNumbersItem) {
  ...
  **/
  ...
  public List<PeopleDataPhoneNumbersInner> getPhoneNumbers() {
    return phoneNumbers;
  }


  public void setPhoneNumbers(List<PeopleDataPhoneNumbersInner> phoneNumbers) {
  ...
  public PeopleData userAccount(Object userAccount) {
  ...
  **/
  ...
  public PeopleData customFields(CustomFieldsResponse customFields) {
  ...
  **/
  ...
  public PeopleData createdAt(String createdAt) {
  ...
  **/
  ...
  public PeopleData updatedAt(String updatedAt) {
  ...
  **/
   ...
   * @return the PeopleData instance itself
   */
  public PeopleData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeopleData peopleData = (PeopleData) o;
    return Objects.equals(this.title, peopleData.title) &&
        Objects.equals(this.id, peopleData.id) &&
        Objects.equals(this.displayName, peopleData.displayName) &&
        Objects.equals(this.firstName, peopleData.firstName) &&
        Objects.equals(this.middleName, peopleData.middleName) &&
        Objects.equals(this.lastName, peopleData.lastName) &&
        Objects.equals(this.preferredName, peopleData.preferredName) &&
        Objects.equals(this.dateOfBirth, peopleData.dateOfBirth) &&
        Objects.equals(this.gender, peopleData.gender) &&
        Objects.equals(this.isSupervisor, peopleData.isSupervisor) &&
        Objects.equals(this.employeeNumber, peopleData.employeeNumber) &&
        Objects.equals(this.autoIncrementIntellihrId, peopleData.autoIncrementIntellihrId) &&
        Objects.equals(this.medicalConditions, peopleData.medicalConditions) &&
        Objects.equals(this.emailAddresses, peopleData.emailAddresses) &&
        Objects.equals(this.emergencyContact, peopleData.emergencyContact) &&
        Objects.equals(this.employmentStatus, peopleData.employmentStatus) &&
        Objects.equals(this.jobs, peopleData.jobs) &&
        Objects.equals(this.workRights, peopleData.workRights) &&
        Objects.equals(this.primaryEmailAddress, peopleData.primaryEmailAddress) &&
        Objects.equals(this.primaryPhoneNumber, peopleData.primaryPhoneNumber) &&
        Objects.equals(this.addresses, peopleData.addresses) &&
        Objects.equals(this.phoneNumbers, peopleData.phoneNumbers) &&
        Objects.equals(this.userAccount, peopleData.userAccount) &&
        Objects.equals(this.customFields, peopleData.customFields) &&
        Objects.equals(this.createdAt, peopleData.createdAt) &&
        Objects.equals(this.updatedAt, peopleData.updatedAt)&&
        Objects.equals(this.additionalProperties, peopleData.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeopleData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeopleData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PeopleData is not found in the empty JSON string", PeopleData.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("medicalConditions") != null && !jsonObj.get("medicalConditions").isJsonNull()) {
        ...
        if (jsonArraymedicalConditions != null) {
          ...
          for (int i = 0; i < jsonArraymedicalConditions.size(); i++) {
            PeopleDataMedicalConditionsInner.validateJsonObject(jsonArraymedicalConditions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("emailAddresses") != null && !jsonObj.get("emailAddresses").isJsonNull()) {
        ...
        if (jsonArrayemailAddresses != null) {
          ...
          for (int i = 0; i < jsonArrayemailAddresses.size(); i++) {
            PeopleDataEmailAddressesInner.validateJsonObject(jsonArrayemailAddresses.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("jobs") != null && !jsonObj.get("jobs").isJsonNull()) {
        ...
        if (jsonArrayjobs != null) {
          ...
          for (int i = 0; i < jsonArrayjobs.size(); i++) {
            PeopleDataJobsInner.validateJsonObject(jsonArrayjobs.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `workRights`
      if (jsonObj.get("workRights") != null && !jsonObj.get("workRights").isJsonNull()) {
        PeopleDataWorkRights.validateJsonObject(jsonObj.getAsJsonObject("workRights"));
      }
      if (jsonObj.get("addresses") != null && !jsonObj.get("addresses").isJsonNull()) {
        ...
        if (jsonArrayaddresses != null) {
          ...
          for (int i = 0; i < jsonArrayaddresses.size(); i++) {
            PeopleDataAddressesInner.validateJsonObject(jsonArrayaddresses.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("phoneNumbers") != null && !jsonObj.get("phoneNumbers").isJsonNull()) {
        ...
        if (jsonArrayphoneNumbers != null) {
          ...
          for (int i = 0; i < jsonArrayphoneNumbers.size(); i++) {
            PeopleDataPhoneNumbersInner.validateJsonObject(jsonArrayphoneNumbers.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeopleData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeopleData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeopleData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeopleData.class));

       return (TypeAdapter<T>) new TypeAdapter<PeopleData>() {
           @Override
           public void write(JsonWriter out, PeopleData value) throws IOException {
           ...
           @Override
           public PeopleData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PeopleData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PeopleData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PeopleData
  * @throws IOException if the JSON string is invalid with respect to PeopleData
  */
  public static PeopleData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeopleData.class);
  }

 /**
  * Convert an instance of PeopleData to an JSON string
  *
  * @return JSON string
  */
