...
import com.konfigthis.client.model.JobRemunerationScheduleAdditionsInner;
import com.konfigthis.client.model.JobRemunerationScheduleAdditionsToTotalInner;
import com.konfigthis.client.model.JobRemunerationScheduleBreakdownsInner;
import com.konfigthis.client.model.JobRemunerationScheduleDeductionsInner;
import com.konfigthis.client.model.JobRemunerationScheduleEmploymentCondition;
...
public class JobRemunerationSchedule {
  ...
  private List<JobRemunerationScheduleAdditionsToTotalInner> additionsToTotal = null;

  public static final String SERIALIZED_NAME_BREAKDOWNS = "breakdowns";
  @SerializedName(SERIALIZED_NAME_BREAKDOWNS)
  private List<JobRemunerationScheduleBreakdownsInner> breakdowns = null;

  public static final String SERIALIZED_NAME_CUSTOM_FIELDS = "customFields";
  @SerializedName(SERIALIZED_NAME_CUSTOM_FIELDS)
  private CustomFieldsResponse customFields = null;

  public JobRemunerationSchedule() {
  }

  public JobRemunerationSchedule type(String type) {
  ...
  **/
  ...
  public JobRemunerationSchedule baseAnnualSalary(Double baseAnnualSalary) {
  ...
  public JobRemunerationSchedule baseAnnualSalary(Integer baseAnnualSalary) {
  ...
  **/
  ...
  public JobRemunerationSchedule baseHourlyRate(Double baseHourlyRate) {
  ...
  public JobRemunerationSchedule baseHourlyRate(Integer baseHourlyRate) {
  ...
  **/
  ...
  public JobRemunerationSchedule currency(String currency) {
  ...
  **/
  ...
  public JobRemunerationSchedule hoursPerCycle(Double hoursPerCycle) {
  ...
  public JobRemunerationSchedule hoursPerCycle(Integer hoursPerCycle) {
  ...
  **/
  ...
  public JobRemunerationSchedule payCycle(String payCycle) {
  ...
  **/
  ...
  public JobRemunerationSchedule annualPackage(Double annualPackage) {
  ...
  public JobRemunerationSchedule annualPackage(Integer annualPackage) {
  ...
  **/
  ...
  public JobRemunerationSchedule hourlyPackage(Double hourlyPackage) {
  ...
  public JobRemunerationSchedule hourlyPackage(Integer hourlyPackage) {
  ...
  **/
  ...
  public JobRemunerationSchedule currencyConversionOccurred(Boolean currencyConversionOccurred) {
  ...
  **/
  ...
  public JobRemunerationSchedule employmentCondition(JobRemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  **/
  ...
  public JobRemunerationScheduleEmploymentCondition getEmploymentCondition() {
    return employmentCondition;
  }


  public void setEmploymentCondition(JobRemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  public JobRemunerationSchedule additions(List<JobRemunerationScheduleAdditionsInner> additions) {
  ...
  public JobRemunerationSchedule addAdditionsItem(JobRemunerationScheduleAdditionsInner additionsItem) {
  ...
  **/
  ...
  public List<JobRemunerationScheduleAdditionsInner> getAdditions() {
    return additions;
  }


  public void setAdditions(List<JobRemunerationScheduleAdditionsInner> additions) {
  ...
  public JobRemunerationSchedule deductions(List<JobRemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobRemunerationSchedule addDeductionsItem(JobRemunerationScheduleDeductionsInner deductionsItem) {
  ...
  **/
  ...
  public List<JobRemunerationScheduleDeductionsInner> getDeductions() {
    return deductions;
  }


  public void setDeductions(List<JobRemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobRemunerationSchedule additionsToTotal(List<JobRemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobRemunerationSchedule addAdditionsToTotalItem(JobRemunerationScheduleAdditionsToTotalInner additionsToTotalItem) {
  ...
  **/
  ...
  public List<JobRemunerationScheduleAdditionsToTotalInner> getAdditionsToTotal() {
    return additionsToTotal;
  }


  public void setAdditionsToTotal(List<JobRemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobRemunerationSchedule breakdowns(List<JobRemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobRemunerationSchedule addBreakdownsItem(JobRemunerationScheduleBreakdownsInner breakdownsItem) {
  ...
  **/
  ...
  public List<JobRemunerationScheduleBreakdownsInner> getBreakdowns() {
    return breakdowns;
  }


  public void setBreakdowns(List<JobRemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobRemunerationSchedule customFields(CustomFieldsResponse customFields) {
  ...
  **/
   ...
   * @return the JobRemunerationSchedule instance itself
   */
  public JobRemunerationSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobRemunerationSchedule jobRemunerationSchedule = (JobRemunerationSchedule) o;
    return Objects.equals(this.type, jobRemunerationSchedule.type) &&
        Objects.equals(this.baseAnnualSalary, jobRemunerationSchedule.baseAnnualSalary) &&
        Objects.equals(this.baseHourlyRate, jobRemunerationSchedule.baseHourlyRate) &&
        Objects.equals(this.currency, jobRemunerationSchedule.currency) &&
        Objects.equals(this.hoursPerCycle, jobRemunerationSchedule.hoursPerCycle) &&
        Objects.equals(this.payCycle, jobRemunerationSchedule.payCycle) &&
        Objects.equals(this.annualPackage, jobRemunerationSchedule.annualPackage) &&
        Objects.equals(this.hourlyPackage, jobRemunerationSchedule.hourlyPackage) &&
        Objects.equals(this.currencyConversionOccurred, jobRemunerationSchedule.currencyConversionOccurred) &&
        Objects.equals(this.employmentCondition, jobRemunerationSchedule.employmentCondition) &&
        Objects.equals(this.additions, jobRemunerationSchedule.additions) &&
        Objects.equals(this.deductions, jobRemunerationSchedule.deductions) &&
        Objects.equals(this.additionsToTotal, jobRemunerationSchedule.additionsToTotal) &&
        Objects.equals(this.breakdowns, jobRemunerationSchedule.breakdowns) &&
        Objects.equals(this.customFields, jobRemunerationSchedule.customFields)&&
        Objects.equals(this.additionalProperties, jobRemunerationSchedule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobRemunerationSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobRemunerationSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobRemunerationSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobRemunerationSchedule is not found in the empty JSON string", JobRemunerationSchedule.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("employmentCondition") != null && !jsonObj.get("employmentCondition").isJsonNull()) {
        JobRemunerationScheduleEmploymentCondition.validateJsonObject(jsonObj.getAsJsonObject("employmentCondition"));
      }
      if (jsonObj.get("additions") != null && !jsonObj.get("additions").isJsonNull()) {
        ...
        if (jsonArrayadditions != null) {
          ...
          for (int i = 0; i < jsonArrayadditions.size(); i++) {
            JobRemunerationScheduleAdditionsInner.validateJsonObject(jsonArrayadditions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("deductions") != null && !jsonObj.get("deductions").isJsonNull()) {
        ...
        if (jsonArraydeductions != null) {
          ...
          for (int i = 0; i < jsonArraydeductions.size(); i++) {
            JobRemunerationScheduleDeductionsInner.validateJsonObject(jsonArraydeductions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("additionsToTotal") != null && !jsonObj.get("additionsToTotal").isJsonNull()) {
        ...
        if (jsonArrayadditionsToTotal != null) {
          ...
          for (int i = 0; i < jsonArrayadditionsToTotal.size(); i++) {
            JobRemunerationScheduleAdditionsToTotalInner.validateJsonObject(jsonArrayadditionsToTotal.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("breakdowns") != null && !jsonObj.get("breakdowns").isJsonNull()) {
        ...
        if (jsonArraybreakdowns != null) {
          ...
          for (int i = 0; i < jsonArraybreakdowns.size(); i++) {
            JobRemunerationScheduleBreakdownsInner.validateJsonObject(jsonArraybreakdowns.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobRemunerationSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobRemunerationSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobRemunerationSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobRemunerationSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<JobRemunerationSchedule>() {
           @Override
           public void write(JsonWriter out, JobRemunerationSchedule value) throws IOException {
           ...
           @Override
           public JobRemunerationSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobRemunerationSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobRemunerationSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobRemunerationSchedule
  * @throws IOException if the JSON string is invalid with respect to JobRemunerationSchedule
  */
  public static JobRemunerationSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobRemunerationSchedule.class);
  }

 /**
  * Convert an instance of JobRemunerationSchedule to an JSON string
  *
  * @return JSON string
  */
