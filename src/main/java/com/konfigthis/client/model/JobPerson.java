...
public class JobPerson {
  ...
  **/
  ...
  public JobPerson displayName(String displayName) {
  ...
  **/
  ...
  public JobPerson employeeNumber(Object employeeNumber) {
  ...
  **/
  ...
  public JobPerson autoIncrementIntellihrId(Double autoIncrementIntellihrId) {
  ...
  public JobPerson autoIncrementIntellihrId(Integer autoIncrementIntellihrId) {
  ...
  **/
  ...
  public JobPerson link(String link) {
  ...
  **/
   ...
   * @return the JobPerson instance itself
   */
  public JobPerson putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobPerson jobPerson = (JobPerson) o;
    return Objects.equals(this.id, jobPerson.id) &&
        Objects.equals(this.displayName, jobPerson.displayName) &&
        Objects.equals(this.employeeNumber, jobPerson.employeeNumber) &&
        Objects.equals(this.autoIncrementIntellihrId, jobPerson.autoIncrementIntellihrId) &&
        Objects.equals(this.link, jobPerson.link)&&
        Objects.equals(this.additionalProperties, jobPerson.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobPerson
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobPerson.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobPerson is not found in the empty JSON string", JobPerson.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobPerson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobPerson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobPerson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobPerson.class));

       return (TypeAdapter<T>) new TypeAdapter<JobPerson>() {
           @Override
           public void write(JsonWriter out, JobPerson value) throws IOException {
           ...
           @Override
           public JobPerson read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobPerson instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobPerson given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobPerson
  * @throws IOException if the JSON string is invalid with respect to JobPerson
  */
  public static JobPerson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobPerson.class);
  }

 /**
  * Convert an instance of JobPerson to an JSON string
  *
  * @return JSON string
  */
