...
public class TrainingPropertyJob {
  ...
  public TrainingPropertyJob() {
  }

  public TrainingPropertyJob id(String id) {
  ...
  **/
  ...
  public TrainingPropertyJob name(String name) {
  ...
  **/
  ...
  public TrainingPropertyJob startDate(String startDate) {
  ...
  **/
  ...
  public TrainingPropertyJob endDate(Object endDate) {
  ...
  **/
  ...
  public TrainingPropertyJob jobStatus(String jobStatus) {
  ...
  **/
  ...
  public TrainingPropertyJob link(String link) {
  ...
  **/
   ...
   * @return the TrainingPropertyJob instance itself
   */
  public TrainingPropertyJob putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TrainingPropertyJob trainingPropertyJob = (TrainingPropertyJob) o;
    return Objects.equals(this.id, trainingPropertyJob.id) &&
        Objects.equals(this.name, trainingPropertyJob.name) &&
        Objects.equals(this.startDate, trainingPropertyJob.startDate) &&
        Objects.equals(this.endDate, trainingPropertyJob.endDate) &&
        Objects.equals(this.jobStatus, trainingPropertyJob.jobStatus) &&
        Objects.equals(this.link, trainingPropertyJob.link)&&
        Objects.equals(this.additionalProperties, trainingPropertyJob.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingPropertyJob {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrainingPropertyJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrainingPropertyJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingPropertyJob is not found in the empty JSON string", TrainingPropertyJob.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingPropertyJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingPropertyJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingPropertyJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingPropertyJob.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingPropertyJob>() {
           @Override
           public void write(JsonWriter out, TrainingPropertyJob value) throws IOException {
           ...
           @Override
           public TrainingPropertyJob read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TrainingPropertyJob instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TrainingPropertyJob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrainingPropertyJob
  * @throws IOException if the JSON string is invalid with respect to TrainingPropertyJob
  */
  public static TrainingPropertyJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingPropertyJob.class);
  }

 /**
  * Convert an instance of TrainingPropertyJob to an JSON string
  *
  * @return JSON string
  */
