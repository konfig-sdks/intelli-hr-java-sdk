...
import com.konfigthis.client.model.JobProperty3RemunerationScheduleAdditionsInner;
import com.konfigthis.client.model.JobProperty3RemunerationScheduleAdditionsToTotalInner;
import com.konfigthis.client.model.JobProperty3RemunerationScheduleBreakdownsInner;
import com.konfigthis.client.model.JobProperty3RemunerationScheduleDeductionsInner;
import com.konfigthis.client.model.JobProperty3RemunerationScheduleEmploymentCondition;
...
public class JobProperty3RemunerationSchedule {
  ...
  private JobProperty3RemunerationScheduleEmploymentCondition employmentCondition;

  public static final String SERIALIZED_NAME_ADDITIONS = "additions";
  @SerializedName(SERIALIZED_NAME_ADDITIONS)
  private List<JobProperty3RemunerationScheduleAdditionsInner> additions = null;

  public static final String SERIALIZED_NAME_DEDUCTIONS = "deductions";
  @SerializedName(SERIALIZED_NAME_DEDUCTIONS)
  private List<JobProperty3RemunerationScheduleDeductionsInner> deductions = null;
  ...
  private List<JobProperty3RemunerationScheduleAdditionsToTotalInner> additionsToTotal = null;

  public static final String SERIALIZED_NAME_BREAKDOWNS = "breakdowns";
  @SerializedName(SERIALIZED_NAME_BREAKDOWNS)
  private List<JobProperty3RemunerationScheduleBreakdownsInner> breakdowns = null;

  public static final String SERIALIZED_NAME_CUSTOM_FIELDS = "customFields";
  @SerializedName(SERIALIZED_NAME_CUSTOM_FIELDS)
  private CustomFieldsResponse customFields = null;

  public JobProperty3RemunerationSchedule() {
  }

  public JobProperty3RemunerationSchedule type(String type) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule baseAnnualSalary(Double baseAnnualSalary) {
  ...
  public JobProperty3RemunerationSchedule baseAnnualSalary(Integer baseAnnualSalary) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule baseHourlyRate(Double baseHourlyRate) {
  ...
  public JobProperty3RemunerationSchedule baseHourlyRate(Integer baseHourlyRate) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule currency(String currency) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule hoursPerCycle(Double hoursPerCycle) {
  ...
  public JobProperty3RemunerationSchedule hoursPerCycle(Integer hoursPerCycle) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule payCycle(String payCycle) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule annualPackage(Double annualPackage) {
  ...
  public JobProperty3RemunerationSchedule annualPackage(Integer annualPackage) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule hourlyPackage(Double hourlyPackage) {
  ...
  public JobProperty3RemunerationSchedule hourlyPackage(Integer hourlyPackage) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule currencyConversionOccurred(Boolean currencyConversionOccurred) {
  ...
  **/
  ...
  public JobProperty3RemunerationSchedule employmentCondition(JobProperty3RemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  **/
  ...
  public JobProperty3RemunerationScheduleEmploymentCondition getEmploymentCondition() {
    return employmentCondition;
  }


  public void setEmploymentCondition(JobProperty3RemunerationScheduleEmploymentCondition employmentCondition) {
  ...
  public JobProperty3RemunerationSchedule additions(List<JobProperty3RemunerationScheduleAdditionsInner> additions) {
  ...
  public JobProperty3RemunerationSchedule addAdditionsItem(JobProperty3RemunerationScheduleAdditionsInner additionsItem) {
  ...
  **/
  ...
  public List<JobProperty3RemunerationScheduleAdditionsInner> getAdditions() {
    return additions;
  }


  public void setAdditions(List<JobProperty3RemunerationScheduleAdditionsInner> additions) {
  ...
  public JobProperty3RemunerationSchedule deductions(List<JobProperty3RemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobProperty3RemunerationSchedule addDeductionsItem(JobProperty3RemunerationScheduleDeductionsInner deductionsItem) {
  ...
  **/
  ...
  public List<JobProperty3RemunerationScheduleDeductionsInner> getDeductions() {
    return deductions;
  }


  public void setDeductions(List<JobProperty3RemunerationScheduleDeductionsInner> deductions) {
  ...
  public JobProperty3RemunerationSchedule additionsToTotal(List<JobProperty3RemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobProperty3RemunerationSchedule addAdditionsToTotalItem(JobProperty3RemunerationScheduleAdditionsToTotalInner additionsToTotalItem) {
  ...
  **/
  ...
  public List<JobProperty3RemunerationScheduleAdditionsToTotalInner> getAdditionsToTotal() {
    return additionsToTotal;
  }


  public void setAdditionsToTotal(List<JobProperty3RemunerationScheduleAdditionsToTotalInner> additionsToTotal) {
  ...
  public JobProperty3RemunerationSchedule breakdowns(List<JobProperty3RemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobProperty3RemunerationSchedule addBreakdownsItem(JobProperty3RemunerationScheduleBreakdownsInner breakdownsItem) {
  ...
  **/
  ...
  public List<JobProperty3RemunerationScheduleBreakdownsInner> getBreakdowns() {
    return breakdowns;
  }


  public void setBreakdowns(List<JobProperty3RemunerationScheduleBreakdownsInner> breakdowns) {
  ...
  public JobProperty3RemunerationSchedule customFields(CustomFieldsResponse customFields) {
  ...
  **/
   ...
   * @return the JobProperty3RemunerationSchedule instance itself
   */
  public JobProperty3RemunerationSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobProperty3RemunerationSchedule jobProperty3RemunerationSchedule = (JobProperty3RemunerationSchedule) o;
    return Objects.equals(this.type, jobProperty3RemunerationSchedule.type) &&
        Objects.equals(this.baseAnnualSalary, jobProperty3RemunerationSchedule.baseAnnualSalary) &&
        Objects.equals(this.baseHourlyRate, jobProperty3RemunerationSchedule.baseHourlyRate) &&
        Objects.equals(this.currency, jobProperty3RemunerationSchedule.currency) &&
        Objects.equals(this.hoursPerCycle, jobProperty3RemunerationSchedule.hoursPerCycle) &&
        Objects.equals(this.payCycle, jobProperty3RemunerationSchedule.payCycle) &&
        Objects.equals(this.annualPackage, jobProperty3RemunerationSchedule.annualPackage) &&
        Objects.equals(this.hourlyPackage, jobProperty3RemunerationSchedule.hourlyPackage) &&
        Objects.equals(this.currencyConversionOccurred, jobProperty3RemunerationSchedule.currencyConversionOccurred) &&
        Objects.equals(this.employmentCondition, jobProperty3RemunerationSchedule.employmentCondition) &&
        Objects.equals(this.additions, jobProperty3RemunerationSchedule.additions) &&
        Objects.equals(this.deductions, jobProperty3RemunerationSchedule.deductions) &&
        Objects.equals(this.additionsToTotal, jobProperty3RemunerationSchedule.additionsToTotal) &&
        Objects.equals(this.breakdowns, jobProperty3RemunerationSchedule.breakdowns) &&
        Objects.equals(this.customFields, jobProperty3RemunerationSchedule.customFields)&&
        Objects.equals(this.additionalProperties, jobProperty3RemunerationSchedule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobProperty3RemunerationSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobProperty3RemunerationSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobProperty3RemunerationSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobProperty3RemunerationSchedule is not found in the empty JSON string", JobProperty3RemunerationSchedule.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("employmentCondition") != null && !jsonObj.get("employmentCondition").isJsonNull()) {
        JobProperty3RemunerationScheduleEmploymentCondition.validateJsonObject(jsonObj.getAsJsonObject("employmentCondition"));
      }
      if (jsonObj.get("additions") != null && !jsonObj.get("additions").isJsonNull()) {
        ...
        if (jsonArrayadditions != null) {
          ...
          for (int i = 0; i < jsonArrayadditions.size(); i++) {
            JobProperty3RemunerationScheduleAdditionsInner.validateJsonObject(jsonArrayadditions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("deductions") != null && !jsonObj.get("deductions").isJsonNull()) {
        ...
        if (jsonArraydeductions != null) {
          ...
          for (int i = 0; i < jsonArraydeductions.size(); i++) {
            JobProperty3RemunerationScheduleDeductionsInner.validateJsonObject(jsonArraydeductions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("additionsToTotal") != null && !jsonObj.get("additionsToTotal").isJsonNull()) {
        ...
        if (jsonArrayadditionsToTotal != null) {
          ...
          for (int i = 0; i < jsonArrayadditionsToTotal.size(); i++) {
            JobProperty3RemunerationScheduleAdditionsToTotalInner.validateJsonObject(jsonArrayadditionsToTotal.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("breakdowns") != null && !jsonObj.get("breakdowns").isJsonNull()) {
        ...
        if (jsonArraybreakdowns != null) {
          ...
          for (int i = 0; i < jsonArraybreakdowns.size(); i++) {
            JobProperty3RemunerationScheduleBreakdownsInner.validateJsonObject(jsonArraybreakdowns.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobProperty3RemunerationSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobProperty3RemunerationSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobProperty3RemunerationSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobProperty3RemunerationSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<JobProperty3RemunerationSchedule>() {
           @Override
           public void write(JsonWriter out, JobProperty3RemunerationSchedule value) throws IOException {
           ...
           @Override
           public JobProperty3RemunerationSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobProperty3RemunerationSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobProperty3RemunerationSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobProperty3RemunerationSchedule
  * @throws IOException if the JSON string is invalid with respect to JobProperty3RemunerationSchedule
  */
  public static JobProperty3RemunerationSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobProperty3RemunerationSchedule.class);
  }

 /**
  * Convert an instance of JobProperty3RemunerationSchedule to an JSON string
  *
  * @return JSON string
  */
