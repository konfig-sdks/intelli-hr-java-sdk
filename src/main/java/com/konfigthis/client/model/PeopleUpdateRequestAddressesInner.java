...
public class PeopleUpdateRequestAddressesInner {
  ...
  public PeopleUpdateRequestAddressesInner() {
  }

  public PeopleUpdateRequestAddressesInner addressType(String addressType) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner fullAddress(String fullAddress) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner country(String country) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner postcode(String postcode) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner state(String state) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner street(String street) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner suburb(String suburb) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner isPrimary(Boolean isPrimary) {
  ...
  **/
  ...
  public PeopleUpdateRequestAddressesInner customFields(Map<String, BusinessEntitiesPatchRequestCustomFieldsValue> customFields) {
  ...
  public PeopleUpdateRequestAddressesInner putCustomFieldsItem(String key, BusinessEntitiesPatchRequestCustomFieldsValue customFieldsItem) {
  ...
  **/
   ...
   * @return the PeopleUpdateRequestAddressesInner instance itself
   */
  public PeopleUpdateRequestAddressesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeopleUpdateRequestAddressesInner peopleUpdateRequestAddressesInner = (PeopleUpdateRequestAddressesInner) o;
    return Objects.equals(this.addressType, peopleUpdateRequestAddressesInner.addressType) &&
        Objects.equals(this.fullAddress, peopleUpdateRequestAddressesInner.fullAddress) &&
        Objects.equals(this.country, peopleUpdateRequestAddressesInner.country) &&
        Objects.equals(this.postcode, peopleUpdateRequestAddressesInner.postcode) &&
        Objects.equals(this.state, peopleUpdateRequestAddressesInner.state) &&
        Objects.equals(this.street, peopleUpdateRequestAddressesInner.street) &&
        Objects.equals(this.suburb, peopleUpdateRequestAddressesInner.suburb) &&
        Objects.equals(this.isPrimary, peopleUpdateRequestAddressesInner.isPrimary) &&
        Objects.equals(this.customFields, peopleUpdateRequestAddressesInner.customFields)&&
        Objects.equals(this.additionalProperties, peopleUpdateRequestAddressesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PeopleUpdateRequestAddressesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeopleUpdateRequestAddressesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeopleUpdateRequestAddressesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PeopleUpdateRequestAddressesInner is not found in the empty JSON string", PeopleUpdateRequestAddressesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PeopleUpdateRequestAddressesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeopleUpdateRequestAddressesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeopleUpdateRequestAddressesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeopleUpdateRequestAddressesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeopleUpdateRequestAddressesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PeopleUpdateRequestAddressesInner>() {
           @Override
           public void write(JsonWriter out, PeopleUpdateRequestAddressesInner value) throws IOException {
           ...
           @Override
           public PeopleUpdateRequestAddressesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PeopleUpdateRequestAddressesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PeopleUpdateRequestAddressesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PeopleUpdateRequestAddressesInner
  * @throws IOException if the JSON string is invalid with respect to PeopleUpdateRequestAddressesInner
  */
  public static PeopleUpdateRequestAddressesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeopleUpdateRequestAddressesInner.class);
  }

 /**
  * Convert an instance of PeopleUpdateRequestAddressesInner to an JSON string
  *
  * @return JSON string
  */
