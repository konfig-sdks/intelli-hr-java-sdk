...
import com.konfigthis.client.model.JobProperty2;
import com.konfigthis.client.model.JobsMeta;
...
public class Jobs {
  ...
  private JobsMeta meta;

  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private JobProperty2 data;

  public Jobs() {
  }

  public Jobs meta(JobsMeta meta) {
  ...
  **/
  ...
  public JobsMeta getMeta() {
    return meta;
  }


  public void setMeta(JobsMeta meta) {
  ...
  public Jobs data(JobProperty2 data) {
  ...
  **/
  ...
  public JobProperty2 getData() {
    return data;
  }


  public void setData(JobProperty2 data) {
  ...
  public boolean equals(Object o) {
    ...
    Jobs jobs = (Jobs) o;
    return Objects.equals(this.meta, jobs.meta) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        JobsMeta.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        JobProperty2.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
