...
public class QualificationLibraryItemsPatchRequest {
 ...
 public enum QualificationAttachmentRequirementTypeEnum {
  ...
  public QualificationLibraryItemsPatchRequest() {
  }

  public QualificationLibraryItemsPatchRequest name(String name) {
  ...
  **/
  ...
  public QualificationLibraryItemsPatchRequest qualificationTypeId(String qualificationTypeId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "8a5f3ea6-ea6b-4425-8a87-3c256bb7b6f9", value = "The identifier string for the Qualification Type Id.")
  ...
  public QualificationLibraryItemsPatchRequest qualificationExpiryType(QualificationExpiryTypeEnum qualificationExpiryType) {
  ...
  **/
  ...
  public QualificationLibraryItemsPatchRequest qualificationRegistrationNumberVisibilityType(QualificationRegistrationNumberVisibilityTypeEnum qualificationRegistrationNumberVisibilityType) {
  ...
  **/
  ...
  public QualificationLibraryItemsPatchRequest qualificationAttachmentRequirementType(QualificationAttachmentRequirementTypeEnum qualificationAttachmentRequirementType) {
  ...
  **/
  ...
  public QualificationLibraryItemsPatchRequest expiryWarningPeriod(Double expiryWarningPeriod) {
  ...
  public QualificationLibraryItemsPatchRequest expiryWarningPeriod(Integer expiryWarningPeriod) {
  ...
  **/
  ...
  public QualificationLibraryItemsPatchRequest sendExpiryWarning(Boolean sendExpiryWarning) {
  ...
  **/
   ...
   * @return the QualificationLibraryItemsPatchRequest instance itself
   */
  public QualificationLibraryItemsPatchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QualificationLibraryItemsPatchRequest qualificationLibraryItemsPatchRequest = (QualificationLibraryItemsPatchRequest) o;
    return Objects.equals(this.name, qualificationLibraryItemsPatchRequest.name) &&
        Objects.equals(this.qualificationTypeId, qualificationLibraryItemsPatchRequest.qualificationTypeId) &&
        Objects.equals(this.qualificationExpiryType, qualificationLibraryItemsPatchRequest.qualificationExpiryType) &&
        Objects.equals(this.qualificationRegistrationNumberVisibilityType, qualificationLibraryItemsPatchRequest.qualificationRegistrationNumberVisibilityType) &&
        Objects.equals(this.qualificationAttachmentRequirementType, qualificationLibraryItemsPatchRequest.qualificationAttachmentRequirementType) &&
        Objects.equals(this.expiryWarningPeriod, qualificationLibraryItemsPatchRequest.expiryWarningPeriod) &&
        Objects.equals(this.sendExpiryWarning, qualificationLibraryItemsPatchRequest.sendExpiryWarning)&&
        Objects.equals(this.additionalProperties, qualificationLibraryItemsPatchRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class QualificationLibraryItemsPatchRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to QualificationLibraryItemsPatchRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QualificationLibraryItemsPatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QualificationLibraryItemsPatchRequest is not found in the empty JSON string", QualificationLibraryItemsPatchRequest.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) && !jsonObj.get("name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("name").toString()));
      }
      if ((jsonObj.get("qualificationTypeId") != null && !jsonObj.get("qualificationTypeId").isJsonNull()) && !jsonObj.get("qualificationTypeId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualificationLibraryItemsPatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualificationLibraryItemsPatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualificationLibraryItemsPatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualificationLibraryItemsPatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<QualificationLibraryItemsPatchRequest>() {
           @Override
           public void write(JsonWriter out, QualificationLibraryItemsPatchRequest value) throws IOException {
           ...
           @Override
           public QualificationLibraryItemsPatchRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             QualificationLibraryItemsPatchRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of QualificationLibraryItemsPatchRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of QualificationLibraryItemsPatchRequest
  * @throws IOException if the JSON string is invalid with respect to QualificationLibraryItemsPatchRequest
  */
  public static QualificationLibraryItemsPatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualificationLibraryItemsPatchRequest.class);
  }

 /**
  * Convert an instance of QualificationLibraryItemsPatchRequest to an JSON string
  *
  * @return JSON string
  */
