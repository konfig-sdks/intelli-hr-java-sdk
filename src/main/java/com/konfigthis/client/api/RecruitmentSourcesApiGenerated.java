...
public class RecruitmentSourcesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RecruitmentSourcesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RecruitmentSourcesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call findByIdCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/recruitment-sources/{id}";
    ...
    private ApiResponse<RecruitmentSources> findByIdWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = findByIdValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RecruitmentSources>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call findByIdAsync(final ApiCallback<RecruitmentSources> _callback) throws ApiException {
    ...
    public class FindByIdRequestBuilder {
         ...
         */
        public RecruitmentSources execute() throws ApiException {
            ApiResponse<RecruitmentSources> localVarResp = findByIdWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute findById request with HTTP info returned
         * @return ApiResponse&lt;RecruitmentSources&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RecruitmentSources> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RecruitmentSources> _callback) throws ApiException {
    ...
    private okhttp3.Call listAllCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/recruitment-sources";
    ...
    private ApiResponse<RecruitmentSourcesList> listAllWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listAllValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RecruitmentSourcesList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAllAsync(final ApiCallback<RecruitmentSourcesList> _callback) throws ApiException {
    ...
    public class ListAllRequestBuilder {
         ...
         */
        public RecruitmentSourcesList execute() throws ApiException {
            ApiResponse<RecruitmentSourcesList> localVarResp = listAllWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listAll request with HTTP info returned
         * @return ApiResponse&lt;RecruitmentSourcesList&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RecruitmentSourcesList> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RecruitmentSourcesList> _callback) throws ApiException {
