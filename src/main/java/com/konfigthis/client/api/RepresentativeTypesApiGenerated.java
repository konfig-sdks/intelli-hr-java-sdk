...
public class RepresentativeTypesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RepresentativeTypesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RepresentativeTypesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call findByIdCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/representative-types/{id}";
    ...
    private ApiResponse<RepresentativeTypesList> findByIdWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = findByIdValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RepresentativeTypesList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call findByIdAsync(final ApiCallback<RepresentativeTypesList> _callback) throws ApiException {
    ...
    public class FindByIdRequestBuilder {
         ...
         * @return RepresentativeTypesList
         ...
         */
        public RepresentativeTypesList execute() throws ApiException {
            ApiResponse<RepresentativeTypesList> localVarResp = findByIdWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute findById request with HTTP info returned
         * @return ApiResponse&lt;RepresentativeTypesList&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RepresentativeTypesList> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RepresentativeTypesList> _callback) throws ApiException {
    ...
    private okhttp3.Call listAllCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/representative-types";
    ...
    private ApiResponse<RepresentativeTypes> listAllWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listAllValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RepresentativeTypes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAllAsync(final ApiCallback<RepresentativeTypes> _callback) throws ApiException {
    ...
    public class ListAllRequestBuilder {
         ...
         */
        public RepresentativeTypes execute() throws ApiException {
            ApiResponse<RepresentativeTypes> localVarResp = listAllWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listAll request with HTTP info returned
         * @return ApiResponse&lt;RepresentativeTypes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RepresentativeTypes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RepresentativeTypes> _callback) throws ApiException {
