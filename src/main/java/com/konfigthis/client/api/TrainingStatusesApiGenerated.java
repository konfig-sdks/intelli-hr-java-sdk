...
public class TrainingStatusesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TrainingStatusesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TrainingStatusesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listAllCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/training-statuses";
    ...
    private ApiResponse<TrainingStatusesList> listAllWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listAllValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<TrainingStatusesList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAllAsync(final ApiCallback<TrainingStatusesList> _callback) throws ApiException {
    ...
    public class ListAllRequestBuilder {
         ...
         */
        public TrainingStatusesList execute() throws ApiException {
            ApiResponse<TrainingStatusesList> localVarResp = listAllWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listAll request with HTTP info returned
         * @return ApiResponse&lt;TrainingStatusesList&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TrainingStatusesList> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TrainingStatusesList> _callback) throws ApiException {
