...
import com.konfigthis.client.model.WorkflowEvents;
...
public class WorkflowEventsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WorkflowEventsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public WorkflowEventsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call findByIdCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/workflow-events/{id}";
    ...
    private ApiResponse<WorkflowEvents> findByIdWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = findByIdValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<WorkflowEvents>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call findByIdAsync(final ApiCallback<WorkflowEvents> _callback) throws ApiException {
    ...
    public class FindByIdRequestBuilder {
         ...
         */
        public WorkflowEvents execute() throws ApiException {
            ApiResponse<WorkflowEvents> localVarResp = findByIdWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute findById request with HTTP info returned
         * @return ApiResponse&lt;WorkflowEvents&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<WorkflowEvents> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WorkflowEvents> _callback) throws ApiException {
